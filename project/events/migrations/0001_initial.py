# Generated by Django 4.1.7 on 2023-02-26 22:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_students_in_band', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_students_in_color_guard', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_students_in_drill_team', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_buses', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_box_trucks', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_trailers', models.PositiveSmallIntegerField(max_length=200)),
                ('number_of_tractor_trailer_rigs', models.PositiveSmallIntegerField(max_length=200)),
